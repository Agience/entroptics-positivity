"""§9.1, gated: on the anchor a coupling read is a REWEIGHTED average sign.
...
differently weighted sign, which is why §9.1 closes the family.
"""
...
def test_the_read_matches_its_own_definition_exactly(seed):
    ...
    assert EA.channel_alignment(A, B).strength == pytest.approx(centred_alignment(A, B), abs=1e-12)
