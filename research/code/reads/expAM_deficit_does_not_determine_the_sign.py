...
Section 7 reads the deficit as an ONSET detector: it moves while `<sgn>` is still identically 1.
...
The diagnostic is the one already used in section 9: an estimator whose quoted error GROWS as
...
if __name__ == "__main__":
    ...
    print("section 7 claims onset and not severity.")
